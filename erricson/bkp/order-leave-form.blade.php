<div class="card">
    <div class="card-body">
        <h5 class="card-title text-center mb-4">TRAVEL ORDER LEAVE FORM</h5>
        <form class="needs-validation row g-3" id="travel_order_form">
            ...
            <div class="row mb-3">
                <div class="col-sm-3">
                    <label for="Ext" class="form-label text-primary">Ext.</label><span class="text-danger">*</span>
                ...
                <div class="col-sm-3">
                    <label for="ordernumber" class="form-label text-primary">Order Number</label><span class="text-danger">
                        *</span>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <label for="arrivaldate" class="form-label text-primary">Arrival Date</label><span class="text-danger">
                        *</span>
                ...
                <div class="col-md-4">
                    <label for="destination" class="form-label text-primary">Destination</label><span class="text-danger">
                        *</span>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <input type="radio" class="form-check-input" id="bussiess" name="trip_type" value="Business">
            ...
            <div class="container mt-3">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="radio" class="form-check-input" id="economy" name="trip_class" value="economy">
                        <label for="economy" class="form-label text-primary">Economy</label>
                    </div>
                    <div class="col-sm-3">

                        <input type="radio" class="form-check-input" id="excursion" name="trip_class" value="excursion">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h5 class="card-title">Add Accompanying Family Members:
                            <button type="button" id="addFieldButton2" class="btn btn-success btn-sm p-0.5">Add</button>
                        </h5>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-sm-4">
                        <input type="radio" class="form-check-input" id="employeeonly" name="accompany_type" value="Employee Only">
                        <label for="employeeonly" class="form-label text-primary">Employee Only</label>
                    </div>
                    <div class="col-sm-4">
                        <input type="radio" class="form-check-input" id="employeefamily" name="accompany_type" value="Employee & Family">
                        <label for="employeefamily" class="form-label text-primary">Employee & Family</label>
                    </div>
                    <div class="col-sm-4">
                        <input type="radio" class="form-check-input" id="familyonly" name="accompany_type" value="Family Only">
                ...
                <div class="row mt-3">
                    <div class="col-sm-4">
                        <input type="radio" class="form-check-input" id="exitreentryisva" name="visa_type" value="Exit & Re-entry Visa">
                        <label for="exitreentryisva" class="form-label text-primary">Exit & Re-entry Visa</label>
                    </div>
                    <div class="col-sm-4">

                        <input type="radio" class="form-check-input" id="exitvisa" name="visa_type" value="Exit Visa">
                        <label for="exitvisa" class="form-label text-primary">Exit Visa</label>
                    </div>
                    <div class="col-sm-4">

                        <input type="checkbox" class="form-check-input" id="reservation" name="reservation" value="1">
